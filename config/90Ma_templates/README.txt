...
The 3rd configuration files "GCM_input_condition" associated with all given simulations are stored in the current directory, and are
already pointed toward in the corresponding "IO_CONDITIONS..." files.
